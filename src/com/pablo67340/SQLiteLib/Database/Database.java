...
public abstract class Database {
	...
	public void initialize() {
		...
		try {
			...
			SQLiteLib.INSTANCE.getLogger().log(Level.SEVERE, "Unable to retreive connection", ex);
		}
	}
	...
	public Boolean executeStatement(String statement) {
		...
		try {
			...
			SQLiteLib.INSTANCE.getLogger().log(Level.SEVERE, Errors.sqlConnectionExecute(), ex);
			return false;
		} finally {
			try {
				if (ps != null)
				...
				SQLiteLib.INSTANCE.getLogger().log(Level.SEVERE, Errors.sqlConnectionClose(), ex);
				return false;
			}
		}
	}
	...
	public void close(PreparedStatement ps, ResultSet rs) {
		try {
			...
			//Error.close(SQLiteLib.INSTANCE, ex);
		}
	}
