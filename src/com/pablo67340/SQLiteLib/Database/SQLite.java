	...
	public Connection getSQLConnection() {
		...
		if (!folder.exists()) {
			try {
				...
				SQLiteLib.INSTANCE.getLogger().log(Level.SEVERE, "File write error: " + dbname + ".db");
			}
		}
		try {
			...
			SQLiteLib.INSTANCE.getLogger().log(Level.SEVERE, "SQLite exception on initialize", ex);
		} catch (ClassNotFoundException ex) {
			SQLiteLib.INSTANCE.getLogger().log(Level.SEVERE,
